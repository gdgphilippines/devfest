...
RegisterHtmlTemplate.register("<dom-module id=devfest-landing-page> <template> <style include=devfest-theme></style> <header class=header> <div class=header-white></div> <div class=header-container> <div class=header-image-text-container> <div class=header-image> <img src=/images/header.gif alt=\"GDG Devfest Philippines 2017 10x Inspiration Ingenuity Impact\"> </div> <div class=header-text> <h1>October 14, 2017</h1> <a href=https://devfestphilippines.eventbrite.com/ class=button target=_blank> <paper-ripple></paper-ripple> Get Tickets </a> </div> </div> </div> </header> </template> </dom-module>");

(function () {
  var DevfestLandingPage = function (_Polymer$Element) {
    _inherits(DevfestLandingPage, _Polymer$Element);

    function DevfestLandingPage() {
      _classCallCheck(this, DevfestLandingPage);

      return _possibleConstructorReturn(this, (DevfestLandingPage.__proto__ || Object.getPrototypeOf(DevfestLandingPage)).apply(this, arguments));
    }

    _createClass(DevfestLandingPage, [{
      key: 'connectedCallback',
      value: function connectedCallback() {
        _get(DevfestLandingPage.prototype.__proto__ || Object.getPrototypeOf(DevfestLandingPage.prototype), 'connectedCallback', this).call(this);
      ...
      key: '_fetchContent',
      value: function _fetchContent() {
        var _this2 = this;

        var link = '/api/landing-temp-link';
        this._db.get(link).then(function (doc) {
          _this2.tempLink = doc.data;
        });
        ...
        fetch(link).then(function (res) {
          ...
          if (json.success) {
            _this2.tempLink = json.data;
            _this2._db.upsert(link, function (doc) {
              doc.data = json.data;
              return doc;
            });
          }
      ...
      key: '_shareFacebookLink',
      value: function _shareFacebookLink() {
      ...
      key: '_shareTwitterLink',
      value: function _shareTwitterLink() {
