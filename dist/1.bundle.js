...
RegisterHtmlTemplate.register("<dom-module id=devfest-call-for-speakers-page> <template> <style include=devfest-theme>.header-paragraph{margin:0 auto;width:80%;max-width:600px;font-size:1.5em;padding-bottom:30px}@media only screen and (max-width:500px){.header-paragraph{font-size:1em}}.header-paragraph-2{padding-top:30px}</style> <header class=header> <div class=header-white></div> <div class=header-container> <div class=header-image-text-container> <div class=header-image> <img src=/images/header.gif alt=\"GDG Devfest Philippines 2017 10x Inspiration Ingenuity Impact\"> </div> <div class=header-text> <h1>Call for Speakers</h1> <p class=header-paragraph> We are very excited to announce a Call for Speakers for GDG DevFest Philippines. We would be delighted to receive and review your proposal from local and international speakers. </p> <a href=[[callforspeakers]] class=button target=_blank> <paper-ripple></paper-ripple> Call for Speakers </a> <p class=\"header-paragraph header-paragraph-2\"> More information below... </p> </div> </div> </div> </header> <section class=speaker-perks> <h1>Speaker Perks</h1> <p> Selected Speakers will be given the following perks: </p><ul> <template is=dom-repeat items=[[perks]]> <li>[[item.perk]]</li> </template> </ul> <p></p> </section> <section class=proposal-guidelines> <h1>Topic Proposal Guidelines</h1> <p> Your topic proposal can fall into one of the categories: </p><ul> <template is=dom-repeat items=[[categories]]> <li>[[item.category]]</li> </template> </ul> <p></p> <p> Topic for the conference should fall into one of the key topics below: </p><ul> <template is=dom-repeat items=[[topics]] as=main> <li>[[main.topic]] <ul> <template is=dom-repeat items=[[main.subtopics]] as=topic> <li>[[topic.topic]]</li> <ul> <template is=dom-repeat items=[[topic.subtopics]] as=subtopic> <li>[[subtopic.topic]]</li> </template> </ul> </template> </ul> </li> </template> </ul> <p></p> <p> Topic Submission will be a single-speaker session only. Click below to submit your proposal: </p> <a href=[[callforspeakers]] class=button target=_blank> <paper-ripple></paper-ripple> Call for Speakers </a> </section> <section class=important-dates> <h1>Important dates to remember</h1> <p> Please be reminded of these important dates in submitting your proposal. </p><ul> <template is=dom-repeat items=[[dates]]> <li>[[item.date]]</li> </template> </ul> <p></p> </section> </template> </dom-module>");

(function () {
  var DevfestCallForSpeakersPage = function (_Polymer$Element) {
    _inherits(DevfestCallForSpeakersPage, _Polymer$Element);

    function DevfestCallForSpeakersPage() {
      _classCallCheck(this, DevfestCallForSpeakersPage);

      return _possibleConstructorReturn(this, (DevfestCallForSpeakersPage.__proto__ || Object.getPrototypeOf(DevfestCallForSpeakersPage)).apply(this, arguments));
    }

    _createClass(DevfestCallForSpeakersPage, null, [{
      key: 'is',
      get: function get() {
        return 'devfest-call-for-speakers-page';
      }
    }, {
      key: 'properties',
      get: function get() {
        return {
          ...
          perks: {
            type: Array,
            value: [{
              perk: 'Free Accommodation'
            }, {
              perk: 'Video Recording of your session'
            }, {
              perk: 'DevFest Shirt'
            }, {
              perk: 'Food and Drinks'
            }, {
              perk: 'Access to DevFest After Party'
            }]
          },
          ...
          categories: {
            type: Array,
            value: [{
              category: 'Lecture (45 minutes)'
            }, {
              category: 'Workshop (1.5 hours)'
            }]
          },
          ...
          dates: {
            type: Array,
            value: [{
              date: 'Deadline for Submission: September 2, 2017'
            }, {
              date: 'Notice of Acceptance: September 5, 2017'
            }]
          }
        };
      }
    ...
    return DevfestCallForSpeakersPage;
  }(Polymer.Element);
...
RegisterHtmlTemplate.toBody("<link href=\"https://fonts.googleapis.com/css?family=Roboto\" rel=stylesheet>");

RegisterHtmlTemplate.toBody("<link href=\"https://fonts.googleapis.com/css?family=Product+Sans\" rel=stylesheet type=text/css>");
...
RegisterHtmlTemplate.register("<dom-module id=devfest-theme> <template> <style>.header{font-family:Roboto;position:relative;min-height:100vh;background:url('" + __webpack_require__(59) + "') center/contain repeat}.header>.header-white{background:rgba(255,255,255,.75);min-height:100%;position:absolute;width:100%;top:0;bottom:0;left:0;right:0}.header>.header-container{position:relative;height:100vh;@apply --layout-horizontal;@apply --layout-center;}.header>.header-container>.header-image-text-container{@apply --layout-flex;}.header>.header-container>.header-image-text-container>.header-image{position:relative;width:inherit;text-align:center}.header>.header-container>.header-image-text-container>.header-image>img{width:80%;max-width:600px}.header>.header-container>.header-image-text-container>.header-text{text-align:center}.header>.header-container>.header-image-text-container>.header-text>h1{font-family:'Product Sans';opacity:.75}.temp-link{padding:20px;padding-top:0;font-family:Roboto,Arial,sans-serif;color:#666;line-height:150%;font-size:1.25em;text-align:center;margin:0 auto;max-width:550px;padding-bottom:100px}@media only screen and (max-width:500px){.temp-link{font-size:1em}}.button{background:#2e9be6;color:#fff;border:3px solid #2e9be6;padding:24px;font-size:24px;display:inline-block;text-transform:uppercase;font-weight:700;text-decoration:none}:host{font-family:Roboto,Arial,sans-serif}</style> </template> </dom-module>");
...
module.exports = __webpack_require__.p + "../../images/devfest-bg-repeatable.png";
