...
RegisterHtmlTemplate.register("<dom-module id=devfest-not-found-page> <template> <style></style> Not found </template> </dom-module>");

(function () {
  var DevfestNotFoundPage = function (_Polymer$Element) {
    _inherits(DevfestNotFoundPage, _Polymer$Element);

    function DevfestNotFoundPage() {
      _classCallCheck(this, DevfestNotFoundPage);

      return _possibleConstructorReturn(this, (DevfestNotFoundPage.__proto__ || Object.getPrototypeOf(DevfestNotFoundPage)).apply(this, arguments));
    }

    _createClass(DevfestNotFoundPage, null, [{
      key: 'is',
      get: function get() {
        return 'devfest-not-found-page';
      }
    }]);

    return DevfestNotFoundPage;
  }(Polymer.Element);
